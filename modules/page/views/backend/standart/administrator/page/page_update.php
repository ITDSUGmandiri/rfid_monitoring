...
<script src="<?= BASE_ASSET ?>spectrum/spectrum.js" type="text/javascript"></script>
<script src="<?= BASE_ASSET ?>js/page.js" type="text/javascript"></script>

<?php $this->load->view('core_template/fine_upload'); ?>

<section class="content-header">
  <h1>
    <?= cclang('page'); ?> <small><?= cclang('update', cclang('page')); ?></small>
  </h1>
  <ol class="breadcrumb">
          ...
          <div class="nav-tabs-custom padding-left-0 tab-page ">
            ...
            <div class="tab-content">
              <div class="tab-pane rest-page-test active" id="tab_1">
                <div class="box box-widget widget-user-2">
                  ...
                  <div class="form-group  wrapper-options-crud">
                    ...
                    <div class="col-sm-8">
                      <div class="col-sm-2 padding-left-0">
                        <label>
                          <input type="radio" class="flat-red" name="type" value="frontend" <?= $page->type == 'frontend' ? 'checked' : ''; ?>> <?= cclang('frontend'); ?>
                        </label>
                      </div>
                      <div class="col-sm-2 padding-left-0">
                        <label>
                          <input type="radio" class="flat-red" name="type" value="backend" <?= $page->type == 'backend' ? 'checked' : ''; ?>> <?= cclang('backend'); ?>
                        </label>
                      </div>
                      </select>
                  ...
                  <div class="form-group ">
                    ...
                    <div class="col-sm-8">
                      <textarea id="description" name="description" rows="5" class="textarea form-control"><?= set_value('description', $page->description); ?></textarea>
                      <small class="info help-block">
              ...
              <div class="tab-pane" id="tab_preview">
                ...
                <iframe scrolling="no" width="100%"></iframe>
              </div>
...
<aside class="control-sidebar control-sidebar-dark toolbox-form">
  ...
  <div class="tab-content height-100prn">
...
<aside class=" toolbox-detail-element wrap ">
...
<script src="<?= BASE_ASSET ?>js/page/page/page-update.js"></script>