               ...
               <div class="box box-widget widget-user-2">
                  <div class="widget-user-header ">
                     <div class="row pull-right">
                        ...
                        <a class="btn btn-flat btn-success btn_add_new" id="btn_add_new" title="<?= cclang('add_new_button', [cclang('tb_master_aset')]); ?>  (Ctrl+a)" href="<?=  admin_site_url('/tb_master_aset/add'); ?>"><i class="fa fa-plus-square-o" ></i> <?= cclang('add_new_button', [cclang('tb_master_aset')]); ?></a>
                        <?php }) ?>
                     ...
                     <!-- /.widget-user-image -->
                     <h3 class="widget-user-username"><?= cclang('tb_master_aset') ?></h3>
                  ...
                  <table class="table table-bordered table-striped dataTable">
                     <thead>
                        <tr class="">
                           ...
                           <th data-field="kategori"data-sort="1" data-primary-key="0"> <?= cclang('kategori') ?></th>
                           ...
                           <th data-field="id_kondisi"data-sort="1" data-primary-key="0"> <?= cclang('id_kondisi') ?></th>
                           <th data-field="status"data-sort="1" data-primary-key="0"> <?= cclang('status') ?></th>
                           <th data-field="tipe_moving"data-sort="1" data-primary-key="0"> <?= cclang('tipe_moving') ?></th>
                           <th data-field="nama_aset"data-sort="1" data-primary-key="0"> <?= cclang('nama_aset') ?></th>
                           ...
                           <th data-field="tgl_perolehan"data-sort="1" data-primary-key="0"> <?= cclang('tgl_perolehan') ?></th>
                           <th data-field="tgl_inventarisasi"data-sort="1" data-primary-key="0"> <?= cclang('tgl_inventarisasi') ?></th>
                           <th data-field="flag_inventarisasi"data-sort="1" data-primary-key="0"> <?= cclang('flag_inventarisasi') ?></th>
                           <th data-field="tgl_peminjaman"data-sort="1" data-primary-key="0"> <?= cclang('tgl_peminjaman') ?></th>
                           <th data-field="tgl_pengembalian"data-sort="1" data-primary-key="0"> <?= cclang('tgl_pengembalian') ?></th>
                           <th data-field="tgl_mutasi"data-sort="1" data-primary-key="0"> <?= cclang('tgl_mutasi') ?></th>
                           <th data-field="id_lokasi_moving"data-sort="1" data-primary-key="0"> <?= cclang('id_lokasi_moving') ?></th>
                           <th data-field="id_pegawai"data-sort="1" data-primary-key="0"> <?= cclang('id_pegawai') ?></th>
                           <th>Action</th>                        </tr>
                     </thead>
