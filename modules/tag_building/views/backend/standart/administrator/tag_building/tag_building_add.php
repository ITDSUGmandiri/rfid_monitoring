...
<section class="content-header">
    <h1>
        Building        <small><?= cclang('new', ['Building']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    <div class="box box-widget widget-user-2">
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Building']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            'name' => 'form_tag_building_add',
                            'class' => 'form-horizontal form-step',
                            'id' => 'form_tag_building_add',
                        ...
                        <div class="form-group group-building_name ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="building_name" id="building_name" placeholder="Building Name" value="<?= set_value('building_name'); ?>">
...
<script>
    ...
    var form_tag_building = $('#form_tag_building_add');
    ...
    $.ajax({
            url: ADMIN_BASE_URL + '/tag_building/add_save',
            type: 'POST',
            dataType: 'json',
            data: data_post,
        })
