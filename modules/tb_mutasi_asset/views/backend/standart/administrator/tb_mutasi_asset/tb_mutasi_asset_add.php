...
<section class="content-header">
    <h1>
        Tb Mutasi Asset        <small><?= cclang('new', ['Tb Mutasi Asset']); ?> </small>
    </h1>
    <ol class="breadcrumb">
...
<section class="content">
                ...
                <div class="box-body ">
                    <div class="box box-widget widget-user-2">
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Tb Mutasi Asset']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            'name' => 'form_tb_mutasi_asset_add',
                            'class' => 'form-horizontal form-step',
                            'id' => 'form_tb_mutasi_asset_add',
                        ...
                        <div class="form-group group-mutasi_id ">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="mutasi_id" id="mutasi_id" placeholder="Mutasi Id" value="<?= set_value('mutasi_id'); ?>">
    ...
    <div class="form-group group-code_rfidtag ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="code_rfidtag" id="code_rfidtag" placeholder="Code Rfidtag" value="<?= set_value('code_rfidtag'); ?>">
                                <small class="info help-block">
    ...
    <div class="form-group group-id_room_old ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="id_room_old" id="id_room_old" placeholder="Id Room Old" value="<?= set_value('id_room_old'); ?>">
                                <small class="info help-block">
    ...
    <div class="form-group group-id_room_new ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="id_room_new" id="id_room_new" placeholder="Id Room New" value="<?= set_value('id_room_new'); ?>">
                                <small class="info help-block">
    ...
    <div class="form-group group-tanggal_m ">
                            ...
                            <div class="col-sm-6">
                                <div class="input-group date col-sm-8">
                                    <input type="text" class="form-control pull-right datepicker" name="tanggal_m" placeholder="Tanggal M" id="tanggal_m">
                                </div>
                                <small class="info help-block">
                                    </small>
                            </div>
    ...
    <div class="form-group group-waktu_m ">
                            ...
                            <div class="col-sm-6">
                                <div class="input-group date col-sm-8">
                                    <input type="text" class="form-control pull-right timepicker" name="waktu_m" id="waktu_m">
                                </div>
                                <small class="info help-block">
                                    </small>
                            </div>
...
<script>
    ...
    var form_tb_mutasi_asset = $('#form_tb_mutasi_asset_add');
    ...
    $.ajax({
            url: ADMIN_BASE_URL + '/tb_mutasi_asset/add_save',
            type: 'POST',
            dataType: 'json',
            data: data_post,
        })
