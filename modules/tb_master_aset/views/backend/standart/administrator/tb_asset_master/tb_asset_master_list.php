         ...
         <div class="box box-warning">
            <div class="box-body ">
               <div class="box box-widget widget-user-2">
                  <div class="widget-user-header ">
                     <div class="row pull-right">
                        <?php is_allowed('tb_asset_master_add', function () { ?>
                           <a class="btn btn-flat btn-success btn_add_new" id="btn_add_new" title="<?= cclang('add_new_button', [cclang('tb_asset_master')]); ?>  (Ctrl+a)" href="<?= admin_site_url('/tb_master_aset/add'); ?>"><i class="fa fa-plus-square-o"></i> <?= cclang('add_new_button', [cclang('tb_asset_master')]); ?></a>
                        <?php }) ?>
                        ...
                        <?php }) ?>
                        <?php is_allowed('tb_asset_master_export', function () { ?>
                           <a class="btn btn-flat btn-danger" title="<?= cclang('import'); ?> <?= cclang('tb_asset_master') ?> " href="<?= admin_site_url('/tb_asset_master/reset_data' . $this->input->get('q') . '&f=' . $this->input->get('f')); ?>"><i class="fa fa-file-pdf-o"></i> Reset Data</a>
                        <?php }) ?>
                     </div>
                  ...
                  <form name="form_tb_asset_master" id="form_tb_asset_master" action="<?= admin_base_url('/tb_master_aset/index'); ?>">
                     ...
                     <div class="table-responsive">
                        <table id="exampleas" class="table table-bordered table-striped dataTable">
                           <thead>
                              <tr>
                                 <th data-field="tag_code" data-sort="1" data-primary-key="0" style="text-align: unset;"> <?= cclang('tag_code') ?></th>
                                 <th data-field="kode_brg" data-sort="1" data-primary-key="0" style="text-align: unset;"> <?= cclang('kode_brg') ?></th>
                                 <th data-field="nama_brg" data-sort="1" data-primary-key="0"> <?= cclang('nama_brg') ?></th>
                                 <th data-field="status_id" data-sort="1" data-primary-key="0" style="text-align: unset;"> <?= cclang('status_id') ?></th>
                                 <th>Action</th>
                              </tr>
                           </thead>
                           <tbody id="tbody_tb_asset_master">
                              <?= $tables ?>
                           </tbody>
                        </table>
                        ...
                        <div class="col-md-8">
                           ...
                           <div class="col-sm-3 padd-left-0 ">
                              <select type="text" class="form-control chosen chosen-select" name="f" id="field">
                                 ...
                                 <option <?= $this->input->get('f') == 'status_id' ? 'selected' : ''; ?> value="status_id">Status Id</option>
                              </select>
                           </div>
                           ...
                           <div class="col-sm-1 padd-left-0 ">
                              <a class="btn btn-default btn-flat" name="reset" id="reset" value="Apply" href="<?= admin_base_url('/tb_asset_master'); ?>" title="<?= cclang('reset_filter'); ?>">
