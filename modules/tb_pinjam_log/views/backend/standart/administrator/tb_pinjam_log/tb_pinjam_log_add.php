                ...
                <div class="box-body ">
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="form-group group-pinjam_id ">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="pinjam_id" id="pinjam_id" placeholder="Pinjam Id" value="<?= set_value('pinjam_id'); ?>">
                        ...
                        <div class="form-group group-tanggal_proses ">
                            ...
                            <div class="col-sm-6">
                                <div class="input-group date col-sm-8">
                                    <input type="text" class="form-control pull-right datepicker" name="tanggal_proses" placeholder="Tanggal Proses" id="tanggal_proses">
                                </div>
                                <small class="info help-block">
                                </small>
                            </div>
                        ...
                        <div class="form-group group-job ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="job" id="job" placeholder="Job" value="<?= set_value('job'); ?>">
                                <small class="info help-block">
                        ...
                        <div class="form-group group-dokumen ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="dokumen" id="dokumen" placeholder="Dokumen" value="<?= set_value('dokumen'); ?>">
                                <small class="info help-block">
