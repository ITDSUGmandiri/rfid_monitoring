...
$base = $base = "$http" . $_SERVER['HTTP_HOST']  . "" . $fo;
...
DEFINE('CIP_CIPERING', "AES-128-CTR");
DEFINE('CIP_IV', "1234567891011121");
DEFINE('CIP_KEY', "56888");


defined('DASHBOARD_MENU_ID')  or define('DASHBOARD_MENU_ID', 3);
defined('DISABLE_POPUP_RELATION')  or define('DISABLE_POPUP_RELATION', false);
defined('DISABLE_BULK_ACTION')  or define('DISABLE_BULK_ACTION', false);
defined('DISABLE_PDF_EXPORT')  or define('DISABLE_PDF_EXPORT', false);
