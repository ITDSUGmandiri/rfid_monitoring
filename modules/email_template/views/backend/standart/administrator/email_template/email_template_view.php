                  ...
                  <div class="form-horizontal form-step" name="form_email_template" id="form_email_template">
                     ...
                     <div class="view-nav">
                        <?php is_allowed('email_template_update', function () use ($email_template) { ?>
                           <a class="btn btn-flat btn-info btn_edit btn_action" id="btn_edit" data-stype='back' title="edit email_template (Ctrl+e)" href="<?= admin_site_url('/email_template/edit/' . $email_template->id); ?>"><i class="fa fa-edit"></i> <?= cclang('update', ['Email Template']); ?> </a>
                        <?php }) ?>
                        <a class="btn btn-flat btn-default btn_action" id="btn_back" title="back (Ctrl+x)" href="<?= admin_site_url('/email_template/'); ?>"><i class="fa fa-undo"></i> <?= cclang('go_list_button', ['Email Template']); ?></a>
                     </div>
