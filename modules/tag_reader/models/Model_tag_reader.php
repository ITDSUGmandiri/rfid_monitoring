...
class Model_tag_reader extends MY_Model {
    ...
    public $field_search   = ['room_id', 'reader_name', 'reader_serialnumber', 'reader_type', 'reader_ip', 'reader_port', 'reader_com', 'reader_mode', 'reader_family', 'connecting', 'reader_identity', 'tb_room_master.name_room'];
