                        ...
                        <div class="col-md-8">
                           ...
                           <div class="col-sm-3 padd-left-0 ">
                              <select type="text" class="form-control chosen chosen-select" name="f" id="field">
                                 ...
                                 <option <?= $this->input->get('f') == 'id' ? 'selected' : ''; ?> value="id">Id Gedung</option>
                        ...
                        <table id="exampleas" class="table table-bordered table-striped dataTable">
                           <thead>
                              <tr class="">
                                 ...
                                 <th style="text-align: unset;" data-field="id" data-sort="1" data-primary-key="0"> <?= cclang('id') ?></th>
                                 <th data-field="id_area" data-sort="1" data-primary-key="0"> Area</th>
