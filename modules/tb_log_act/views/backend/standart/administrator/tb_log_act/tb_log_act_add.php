...
<section class="content-header">
    <h1>
        Tb Log Act        <small><?= cclang('new', ['Tb Log Act']); ?> </small>
    </h1>
    <ol class="breadcrumb">
...
<section class="content">
                ...
                <div class="box-body ">
                    <div class="box box-widget widget-user-2">
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Tb Log Act']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            'name' => 'form_tb_log_act_add',
                            'class' => 'form-horizontal form-step',
                            'id' => 'form_tb_log_act_add',
                        ...
                        <div class="form-group group-log_id ">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="log_id" id="log_id" placeholder="Log Id" value="<?= set_value('log_id'); ?>">
    ...
    <div class="form-group group-act_id ">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="act_id" id="act_id" placeholder="Act Id" value="<?= set_value('act_id'); ?>">
                                <small class="info help-block">
    ...
    <div class="form-group group-user ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="user" id="user" placeholder="User" value="<?= set_value('user'); ?>">
                                <small class="info help-block">
    ...
    <div class="form-group group-date ">
                            ...
                            <div class="col-sm-6">
                                <div class="input-group date col-sm-8">
                                    <input type="text" class="form-control pull-right datepicker" name="date" placeholder="Date" id="date">
                                </div>
                                <small class="info help-block">
                                    </small>
                            </div>
    ...
    <div class="form-group group-time ">
                            ...
                            <div class="col-sm-6">
                                <div class="input-group date col-sm-8">
                                    <input type="text" class="form-control pull-right timepicker" name="time" id="time">
                                </div>
                                <small class="info help-block">
                                    </small>
                            </div>
...
<script>
    ...
    var form_tb_log_act = $('#form_tb_log_act_add');
    ...
    $.ajax({
            url: ADMIN_BASE_URL + '/tb_log_act/add_save',
            type: 'POST',
            dataType: 'json',
            data: data_post,
        })
