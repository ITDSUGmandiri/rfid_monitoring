...
<section class="content-header">
  <h1>
    Mailer <small><?= cclang('new', ['Mailer']); ?> </small>
  </h1>
  <ol class="breadcrumb">
        ...
        <div class="box-body ">
          ...
          <div class="box box-widget widget-user-2">
            ...
            <div class="widget-user-header ">
              ...
              <h5 class="widget-user-desc"><?= cclang('new', ['Mailer']); ?></h5>
              <hr>
            </div>
            <?= form_open('', [
              'name'    => 'form_mailer',
            ...
            <div class="form-group ">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control" name="mail_to" id="mail_to" placeholder="Mail To" value="<?= set_value('mail_to'); ?>">
                <small class="info help-block">
...
<script>
  $(document).ready(function() {
    ...
    $('.btn_save').click(function() {
      ...
      $.ajax({
          url: ADMIN_BASE_URL + '/mailer/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
