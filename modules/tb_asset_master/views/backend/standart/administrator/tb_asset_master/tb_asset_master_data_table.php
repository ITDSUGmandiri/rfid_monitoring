<?php foreach($tb_asset_masters as $tb_asset_master): ?>
    <tr>
        ...
        <td><?php if  ($tb_asset_master->Kondisi) {
            ...
            echo admin_anchor('/tb_kondisi_master/view/'.$tb_asset_master->Kondisi.'?popup=show', $tb_asset_master->tb_kondisi_master_keterangan, ['class' => 'popup-view']); }?> </td>
         
        <td><?php if  ($tb_asset_master->Lokasi) {

            echo admin_anchor('/tb_room_master/view/'.$tb_asset_master->Lokasi.'?popup=show', $tb_asset_master->tb_room_master_name_room, ['class' => 'popup-view']); }?> </td>
