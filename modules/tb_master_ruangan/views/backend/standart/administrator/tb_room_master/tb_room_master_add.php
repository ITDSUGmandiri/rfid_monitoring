                ...
                <div class="box-body ">
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="form-group group-name_room ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="name_room" id="name_room" placeholder="Keterangan Ruangan" value="<?= set_value('name_room'); ?>">
                                <small class="info help-block">
                                    <b>Input Name Room</b> Max Length : 30.</small>
                            </div>
                        </div>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="file" name="fotoruang" required="required">
                                <small class="info help-block">
