...
<section class="content">
	...
	<div class="form-group group-kode_gedung  ">
		...
		<div class="col-sm-8">
			<input type="text" class="form-control" name="kode_gedung" id="kode_gedung" placeholder="" value="<?= set_value('kode_gedung', $tb_gedung_master->kode_gedung); ?>">
...
<div class="form-group group-area_id">
        ...
        <div class="col-sm-8">
            <select class="form-control chosen chosen-select-deselect" name="area_id" id="area_id" data-placeholder="Select Area">
                ...
                <option <?= $row->id_area == $tb_gedung_master->area_id ? 'selected' : ''; ?> value="<?= $row->id_area ?>"><?= $row->area; ?></option>
                <?php endforeach; ?>
            </select>
            <small class="info help-block">
                </small>
