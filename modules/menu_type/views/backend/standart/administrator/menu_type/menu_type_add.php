<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?= admin_site_url('/menu_type') ?>">Menu Type</a>
        </li>
                ...
                <div class="box-body ">
                    <div class="box box-widget widget-user-2">
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', 'Menu Type'); ?></h5>
                            <hr>
                        </div>
...
<script src="<?= BASE_ASSET ?>js/page/menu-type/menu-type-add.js"></script>