...
<section class="content">
    ...
    <div class="form-group group-reader_name ">
                            <label for="reader_name" class="col-sm-2 control-label">Reader Name                                <i class="required">*</i>
                                </label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="reader_name" id="reader_name" placeholder="Reader Name" value="<?= set_value('reader_name'); ?>">
                                <small class="info help-block">
    ...
    <div class="form-group group-reader_serialnumber ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="reader_serialnumber" id="reader_serialnumber" placeholder="Reader Serialnumber" value="<?= set_value('reader_serialnumber'); ?>">
                                <small class="info help-block">
    ...
    <div class="form-group group-reader_ip ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="reader_ip" id="reader_ip" placeholder="Reader Ip" value="<?= set_value('reader_ip'); ?>">
                                <small class="info help-block">
    ...
    <div class="form-group group-reader_port ">
                            <label for="reader_port" class="col-sm-2 control-label">Reader Port                                <i class="required">*</i>
                                </label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="reader_port" id="reader_port" placeholder="Reader Port" value="<?= set_value('reader_port'); ?>">
                                <small class="info help-block">
    ...
    <div class="form-group group-reader_power ">
                            <label for="reader_power" class="col-sm-2 control-label">Reader Power                                <i class="required">*</i>
                                </label>
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="reader_power" id="reader_power" placeholder="Reader Power" value="<?= set_value('reader_power'); ?>">
                                <small class="info help-block">
                                    </small>
                            </div>
                        </div>
    ...
    <div class="form-group group-reader_updatedby ">
                            <label for="reader_updatedby" class="col-sm-2 control-label">Reader Updatedby                                <i class="required">*</i>
                                </label>
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="reader_updatedby" id="reader_updatedby" placeholder="Reader Updatedby" value="<?= set_value('reader_updatedby'); ?>">
                                <small class="info help-block">
                                    </small>
                            </div>
                        </div>
    ...
    <div class="form-group group-reader_updated ">
                            <label for="reader_updated" class="col-sm-2 control-label">Reader Updated                                <i class="required">*</i>
                                </label>
                            <div class="col-sm-6">
    ...
    <div class="form-group group-reader_createdby ">
                            <label for="reader_createdby" class="col-sm-2 control-label">Reader Createdby                                <i class="required">*</i>
                                </label>
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="reader_createdby" id="reader_createdby" placeholder="Reader Createdby" value="<?= set_value('reader_createdby'); ?>">
                                <small class="info help-block">
                                    </small>
                            </div>
                        </div>
    ...
    <div class="form-group group-reader_created ">
                            <label for="reader_created" class="col-sm-2 control-label">Reader Created                                <i class="required">*</i>
                                </label>
                            <div class="col-sm-6">
                                <div class="input-group date col-sm-8">
    ...
    <div class="form-group group-reader_family ">
                            <label for="reader_family" class="col-sm-2 control-label">Reader Family                                <i class="required">*</i>
                                </label>
                            <div class="col-sm-8">
    ...
    <div class="form-group  wrapper-options-crud">
                            <label for="connecting" class="col-sm-2 control-label">Connecting                                </label>
                            <div class="col-sm-8">
                                <div class="col-md-3 padding-left-0">
                                        <label>
    ...
    <div class="form-group group-reader_model ">
                            <label for="reader_model" class="col-sm-2 control-label">Reader Model                                <i class="required">*</i>
                                </label>
                            <div class="col-sm-8">
    ...
    <div class="form-group group-reader_antena ">
                            <label for="reader_antena" class="col-sm-2 control-label">Reader Antena                                <i class="required">*</i>
                                </label>
                            <div class="col-sm-8">
