...
class Model_tb_gedung_master extends MY_Model
{
    ...
    public $field_search   = ['id_area', 'id', 'gedung', 'tb_master_area.area'];
    ...
    public function join_avaiable()
    {
        ...
        $this->db->select('tb_master_area.area,tb_master_gedung.*,tb_master_area.area as tb_master_area_kota,tb_master_area.area as kota');
