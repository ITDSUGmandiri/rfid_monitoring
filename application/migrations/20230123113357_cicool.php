...
class Migration_cicool extends CI_Migration
{
        ...
        public function up()
        {
                ...
                app()->dbforge->create_table('crud_input_chained');
                ...
                //create table crud field configuration
                $this->dbforge->add_field(array(
                        'id' => array(
                                'type' => 'INT',
                                'constraint' => 11,
                ...
                $this->dbforge->add_key('id', TRUE);
                $this->dbforge->create_table('crud_field_configuration');
                ...
                $this->db->insert_batch('crud_input_validation', [
                        [
                                'validation' => 'required',
                                'input_able' => 'no',
                                'group_input' => 'input, file, number, text, datetime, select, password, email, editor, date, yes_no, time, year, select_multiple, options, checkboxes, true_false, address_map, custom_option, custom_checkbox, custom_select_multiple, custom_select, file_multiple, chained',
                                'input_placeholder' => '',
                                'call_back' => '',
                                'input_validation' => ''
