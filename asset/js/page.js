...
$(document).ready(function () {
    ...
    $('.btn-mode-phone').on('click', function () {
        checkPreview();
        resetMode();
    ...
    $('.btn-mode-tablet').on('click', function () {
        checkPreview();
        resetMode();
    ...
    $('.btn-mode-desktop').on('click', function () {
        checkPreview();
        resetMode();
    ...
    $('.btn-mode-preview').on('click', function () {
        var data_preview = [];
        var content = '';
        ...
        $('.loading2').show();
        $.ajax({
            url: ADMIN_BASE_URL + '/page/preview',
            dataType: 'json',
            type: 'POST',
            data: data_preview,
        })
    ...
    $('.windows .btn-full-screen').on('click', function () {
    ...
    $('.windows .btn-minimize, windows .btn-close').on('click', function () {
    ...
    $('.btn-round-element').on('click', function () {
    ...
    $('.block-list li a').on('click', function () {
        var state = $(this).data('state');
        switch (state) {
            case 1:
            case undefined:
    ...
    $('.block-list li a#btn-all-element').on('click', function () {
    ...
    function updateWinContent() {
        ...
        $(document).find('.win-content ul li.block-item:not(.block-item-loaded)').each(function () {
            ...
            if (typeof src != 'undefined') {
                ...
                container.hide();
                $.ajax({
                    url: ADMIN_BASE_URL + '/page/get_html',
                    data: {
    ...
    $('#btn_cancel').on('click', function () {
        swal({
            ...
            function (isConfirm) {
                if (isConfirm) {
                    window.location.href = ADMIN_BASE_URL + '/page';
                }
            });
