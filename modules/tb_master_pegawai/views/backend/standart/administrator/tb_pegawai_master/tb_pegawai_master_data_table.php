<?php foreach ($tb_pegawai_masters as $tb_pegawai_master): ?>
    <tr>
        ...
        <td style="text-align: unset;"><span class="list_group-NIP"><?= _ent($tb_pegawai_master->nip); ?></span></td>
        ...
        <td style="text-align: unset;"><span class="list_group-Telp"><?= _ent($tb_pegawai_master->telp); ?></span></td>
