...
class Dashboard extends Admin
{
	...
	public function getSumAsetRoom()
	{
		...
		//status room
		$querycateg = "SELECT c.ruangan,count(a.id_lokasi) as total FROM tb_master_aset a JOIN tb_master_ruangan c ON a.lokasi_moving = c.id AND a.status != 0 AND a.kode_tid != '' GROUP BY c.ruangan";
