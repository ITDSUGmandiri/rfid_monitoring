...
class Model_tb_room_master extends MY_Model
{
    ...
    public $field_search   = ['ruangan', 'id', 'tb_master_gedung.gedung'];
    ...
    {
        $this->db->join('tb_master_gedung', 'tb_master_gedung.id = tb_master_ruangan.id', 'LEFT');

        $this->db->select('tb_master_gedung.gedung,tb_master_ruangan.*,tb_master_gedung.gedung as tb_master_gedung_gedung,tb_master_gedung.gedung as gedung');
