...
<section class="content-header">
    <h1>
        Tb Kondisi Master        <small><?= cclang('new', ['Tb Kondisi Master']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    <div class="box box-widget widget-user-2">
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Tb Kondisi Master']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            'name' => 'form_tb_kondisi_master_add',
                            'class' => 'form-horizontal form-step',
                            'id' => 'form_tb_kondisi_master_add',
                        ...
                        <div class="form-group group-kondisi_id ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="kondisi_id" id="kondisi_id" placeholder="Kondisi Id" value="<?= set_value('kondisi_id'); ?>">
...
<script>
    ...
    var form_tb_kondisi_master = $('#form_tb_kondisi_master_add');
    ...
    $.ajax({
            url: ADMIN_BASE_URL + '/tb_kondisi_master/add_save',
            type: 'POST',
            dataType: 'json',
            data: data_post,
        })
