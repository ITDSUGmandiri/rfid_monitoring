...
<section class="content">
                        ...
                        <div class="form-group group-gedung_id ">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control chosen chosen-select-deselect" name="gedung_id" id="gedung_id" data-placeholder="Select Gedung Id">
                                    ...
                                    <option value="<?= $row->id_gedung ?>"><?= $row->gedung; ?></option>
                                    <?php endforeach; ?>
                                </select>
    ...
    <div class="form-group group-id_room ">
                            <label for="id_room" class="col-sm-2 control-label">Id Room                                </label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="id_room" id="id_room" placeholder="Id Room" value="<?= set_value('id_room'); ?>">
                                <small class="info help-block">
                                    </small>
                            </div>
                        </div>
    ...
    <div class="form-group group-kode_room ">
                            <label for="kode_room" class="col-sm-2 control-label">Kode Room                                </label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="kode_room" id="kode_room" placeholder="Kode Room" value="<?= set_value('kode_room'); ?>">
                                <small class="info help-block">
                                    </small>
                            </div>
                        </div>
