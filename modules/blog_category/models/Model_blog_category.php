...
class Model_blog_category extends MY_Model {
    ...
    public $field_search   = ['category_name', 'category_desc', 'pilihan', 'check'];
    public $sort_option = ['category_name', 'desc'];
    ...
    public function count_all($q = null, $field = null)
    {
        ...
        if (empty($field)) {
            ...
            $where .= "(" . "blog_category.".$field . " LIKE '%" . $q . "%' )";
        }
