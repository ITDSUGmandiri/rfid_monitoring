...
class Model_tb_master_aset extends MY_Model {
    ...
    public $field_search   = ['kode_tid', 'kode_aset', 'nup', 'kategori', 'merk', 'tipe', 'id_kondisi', 'status', 'tipe_moving', 'nama_aset', 'id_area', 'id_gedung', 'id_ruangan', 'tgl_perolehan', 'tgl_inventarisasi', 'flag_inventarisasi', 'tgl_peminjaman', 'tgl_pengembalian', 'tgl_mutasi', 'id_lokasi_moving', 'id_pegawai'];
