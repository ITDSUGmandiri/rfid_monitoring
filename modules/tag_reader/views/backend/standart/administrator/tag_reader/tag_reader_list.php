                     ...
                     <div class="col-md-8">
                        ...
                        <div class="col-sm-3 padd-left-0 " >
                           <select type="text" class="form-control chosen chosen-select" name="f" id="field" >
                            ...
                            <option <?= $this->input->get('f') == 'reader_name' ? 'selected' :''; ?> value="reader_name">Reader Name</option>
                            <option <?= $this->input->get('f') == 'reader_serialnumber' ? 'selected' :''; ?> value="reader_serialnumber">Reader Serialnumber</option>
                            ...
                            <option <?= $this->input->get('f') == 'reader_port' ? 'selected' :''; ?> value="reader_port">Reader Port</option>
                            <option <?= $this->input->get('f') == 'reader_com' ? 'selected' :''; ?> value="reader_com">Reader Com</option>
