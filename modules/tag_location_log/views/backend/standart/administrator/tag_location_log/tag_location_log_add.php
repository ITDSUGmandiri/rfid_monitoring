...
<section class="content-header">
    <h1>
        Location Log        <small><?= cclang('new', ['Location Log']); ?> </small>
    </h1>
    <ol class="breadcrumb">
...
<section class="content">
                ...
                <div class="box-body ">
                    <div class="box box-widget widget-user-2">
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Location Log']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            'name' => 'form_tag_location_log_add',
                            'class' => 'form-horizontal form-step',
                            'id' => 'form_tag_location_log_add',
    ...
    <div class="form-group group-log_status ">
                            <label for="log_status" class="col-sm-2 control-label">Status                                <i class="required">*</i>
                                </label>
                            <div class="col-sm-8">
                                <select class="form-control chosen chosen-select" name="log_status" id="log_status" data-placeholder="Select Status">
                                    <option value=""></option>
...
<script>
    ...
    $('#btn_cancel').click(function() {
        swal({
            ...
            function(isConfirm) {
                if (isConfirm) {
                    window.location.href = ADMIN_BASE_URL + '/tag_location_log';
                }
            });
    ...
    var form_tag_location_log = $('#form_tag_location_log_add');
    var data_post = form_tag_location_log.serializeArray();
    ...
    $.ajax({
            url: ADMIN_BASE_URL + '/tag_location_log/add_save',
            type: 'POST',
            dataType: 'json',
            data: data_post,
        })
        .done(function(res) {
            ...
            if (use_ajax_crud == true) {
                ...
                var url = BASE_URL + ADMIN_NAMESPACE_URL + '/tag_location_log/index/?ajax=1'
                reloadDataTable(url);
            }
