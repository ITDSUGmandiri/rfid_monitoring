                ...
                <div class="box-body ">
                    <div class="box box-widget widget-user-2">
                        ...
                        <?php } elseif ($option['input_type'] == 'editor_wysiwyg') { ?><div class="form-group ">
                            ...
                            <?php } ?></label>
                            <div class="col-sm-8">
                                <textarea id="<?= $input; ?>" name="<?= $input; ?>" rows="10" cols="80">{php_open_tag_echo} set_value('<?= ucwords(clean_snake_case($input)); ?>'); {php_close_tag}</textarea>
                                <small class="info help-block">
                                <?= $this->crud_builder->parseValidationFile($input, '<b>', '</b>', $option['input_label']); ?></small>
                            </div>
                        </div>
                        <?php } elseif ($option['input_type'] == 'textarea') { ?><div class="form-group ">
                            ...
                            <?php } ?></label>
                            <div class="col-sm-8">
                                <textarea id="<?= $input; ?>" name="<?= $input; ?>" rows="10" class="textarea">{php_open_tag_echo} set_value('<?= $input; ?>'); {php_close_tag}</textarea>
                                <small class="info help-block">
                                <?= $this->crud_builder->parseValidationFile($input, '<b>', '</b>', $option['input_label']); ?></small>
                            </div>
                        </div>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: ADMIN_BASE_URL + '/manage-form/{table_name}/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
       ...
       $('#{table_name}_<?= $input; ?>_galery').fineUploader({
          ...
          request: {
              endpoint: ADMIN_BASE_URL + '/manage-form/{table_name}/upload_<?= $input; ?>_file',
              params : params
          },
          deleteFile: {
              enabled: true, 
              endpoint: ADMIN_BASE_URL + '/manage-form/{table_name}/delete_<?= $input; ?>_file',
          },
          thumbnails: {
              placeholders: {
          ...
          callbacks: {
              ...
              onSubmit : function(id, name) {
                  ...
                  $.get(ADMIN_BASE_URL + '/manage-form/{table_name}/delete_<?= $input; ?>_file/' + uuid);
              },
