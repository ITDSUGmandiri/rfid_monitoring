...
class pemindahan extends Admin
{
	...
	public function serverSideData()
	{
		...
		if (empty($this->input->post('search')['value'])) {
			$contents = $this->model_pemindahan->get_content($limit, $start, $order, $dir);
		} else {
			$search = $this->input->post('search')['value'];
			$contents =  $this->model_pemindahan->content_search($limit, $start, $search, $order, $dir);
			$totalFiltered = $this->model_pemindahan->content_search_count($search);
		}
