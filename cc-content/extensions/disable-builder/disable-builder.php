...
if ($ccExtension->actived()) {
   app()->cc_app->onEvent('extension_info_'.EXNAME, function(){
    echo '<div class="callout callout-warning-cc ">go to page '.admin_anchor('/setting/?tab=tab_builder_enabled', 'setting', ['class' => 'btn btn-xs btn-info btn-flat']).' for configuration</div>';
    });
}
