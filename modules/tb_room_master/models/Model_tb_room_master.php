...
class Model_tb_room_master extends MY_Model {
    ...
    public $field_search   = ['gedung_id', 'kode_room', 'name_room', 'lat', 'long', 'tb_gedung_master.gedung'];
    ...
    public function join_avaiable() {
        ...
        $this->db->select('tb_gedung_master.gedung,tb_room_master.*,tb_gedung_master.gedung as tb_gedung_master_gedung,tb_gedung_master.gedung as gedung');
