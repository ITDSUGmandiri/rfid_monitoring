...
function domo(){
   ...
   $('*').bind('keydown', 'Ctrl+a', function() {
       window.location.href = ADMIN_BASE_URL + '/registrasi_aset/add';
       return false;
   });
               ...
               <div class="box box-widget widget-user-2">
                  <div class="widget-user-header ">
                     <div class="row pull-right">
                        ...
                        <a class="btn btn-flat btn-success btn_add_new" id="btn_add_new" title="<?= cclang('add_new_button', [cclang('tb_master_transaksi')]); ?>  (Ctrl+a)" href="<?=  admin_site_url('/registrasi_aset/add'); ?>"><i class="fa fa-plus-square-o" ></i> <?= cclang('add_new_button', [cclang('tb_master_transaksi')]); ?></a>
                        <?php }) ?>
    ...
    $(document).on('click', '#apply', function(){
      ...
      if (bulk.val() == 'delete') {
         swal({
          ...
          function(isConfirm){
            if (isConfirm) {
               document.location.href = ADMIN_BASE_URL + '/registrasi_aset/delete?' + serialize_bulk;      
            }
          });
