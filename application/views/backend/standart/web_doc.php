...
<div class="wrapper">
   <header class="doc-header">
      <div class="container">
         <h2 class="lone-header">Cicool WEB Documentation V-3</h2>
      </div>
   </header>
   <section class="doc-content">
      <div class="container">
         ...
         <div class="docs-content">
            ...
            <p>
               After you create a REST API you can directly view the documentation that automatically created <a href="<?= admin_site_url('/doc/api'); ?>">See API Documentations</a>.
               <br>
            ...
            <p>
               to get tokens you can see more at documentation, <a href="<?= admin_site_url('/doc/api'); ?>">See API Documentations</a>.
               <br>
               or you can visit <a href="<?= admin_site_url('/rest/tool/get-token'); ?>">this link</a> there you can get a token directly by following the instructions provided.
            </p>
    ...
    "data": {
        ...
        "expiration": {
            ...
            <p>
               ...
               Your administrator can access the page that you created in <b><?= base_url(); ?>administrator/page/<b class="text-danger">(your-page-link)</b></b>
               <br>
            <ul id="token_is_generated">
               <li>Build a Administrator Page</li>
            </ul>
...
<script type="text/javascript">
   $(document).ready(function() {
      ...
      $(".doc-content a").on('click', function() {
