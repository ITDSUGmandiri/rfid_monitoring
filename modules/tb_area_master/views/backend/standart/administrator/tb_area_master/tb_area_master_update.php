            ...
            <div class="box box-warning">
                <div class="box-body ">
                    <div class="box box-widget widget-user-2">
                        ...
                        <?= form_open(admin_base_url('/tb_area_master/edit_save/'.$this->uri->segment(4)), [
...
<div class="form-group group-id_area  ">
	...
	<div class="form-group group-kota  ">
		...
		<div class="col-sm-8">
			<input type="text" class="form-control" name="kota" id="kota" placeholder="" value="<?= set_value('kota', $tb_area_master->kota); ?>">
			<small class="info help-block">
				<b>Input Kota</b> Max Length : 50.</small>
		</div>
	</div>
	...
	<div class="form-group group-alamat  ">
		...
		<div class="col-sm-8">
			<input type="text" class="form-control" name="alamat" id="alamat" placeholder="" value="<?= set_value('alamat', $tb_area_master->alamat); ?>">
			<small class="info help-block">
				<b>Input Alamat</b> Max Length : 130.</small>
		</div>
	</div>
	...
	<div class="form-group group-area  ">
		...
		<div class="col-sm-8">
			...
			<small class="info help-block">
				<b>Input Area</b> Max Length : 200.</small>
		</div>
	</div>
