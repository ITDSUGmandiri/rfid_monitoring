...
$route[ADMIN_NAMESPACE_URL . '/login'] = 'auth/backend/auth/login';
$route[ADMIN_NAMESPACE_URL . '/register'] = 'auth/backend/auth/register';
$route[ADMIN_NAMESPACE_URL . '/forgot-password'] = 'auth/backend/auth/forgot_password';
...
$route[ADMIN_NAMESPACE_URL . '/web-page'] = 'page/backend/page/admin';
...
$route[ADMIN_NAMESPACE_URL . '/(:any)/(:any)/(:any)/(:any)'] = '$1/backend/$1/$2/$3/$4';
