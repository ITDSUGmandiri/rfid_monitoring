...
class Model_tag_anomaly extends MY_Model {
    ...
    public $field_search   = ['rfid_id', 'anomaly_right_librarian', 'anomaly_wrong_librarian', 'anomaly_status', 'tag_rfid.rfid_rfid', 'tag_librarian.librarian_name', 'tag_librarian.librarian_name'];
    ...
    public function filter_avaiable() {
        ...
        if (!$this->aauth->is_admin()) {
            $this->db->where($this->table_name.'.anomaly_updatedby', get_user_data('id'));
        }
